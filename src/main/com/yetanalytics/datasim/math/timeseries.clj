...
(comment
  ...
  (repeatedly 10 #(random/rand-exp the-rng 2))
  (let [exp-seq (repeatedly 1000 #(+ (random/rand-exp the-rng 2) 2))]
    (/ (reduce + exp-seq) 1000))

  (take 10 (poisson-seq (random/seed-rng 1234) (/ 1. 2) 2))
  (take 10 (poisson-seq (random/seed-rng 1234) (/ 1. 4)))
  )
